...
| [`leer-solicitudes-freescout`](leer-solicitudes-freescout/) | 1.0.0 | Lista por scraping (solo lectura) las solicitudes pendientes de una casilla de FreeScout (por defecto "SOL Fabrica"); credenciales globales en un `config.env` junto a la skill. |
